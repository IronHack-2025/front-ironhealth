<template>
    <v-card rounded="xl">
        ...
        <v-card-text>
            <InfoRow :label="$t('common.forms.gender')" :value="genderName" icon="mdi-account" icon-color="black" />
            <InfoRow :label="$t('common.forms.dateOfBirth')" :value="formattedBirthDate" icon="mdi-calendar-account" icon-color="green" />
            <InfoRow label="ID" :value="patient._id" icon="mdi-id-card" icon-color="red" />
            <InfoRow :label="$t('common.forms.nationality')" :value="nationalityName" icon="mdi-map-marker" icon-color="blue" />
            ...
            <InfoRow :label="$t('common.forms.emergencyContact')" :value="patient.emergencyContact" icon="mdi-phone-alert" />
        </v-card-text>
    </v-card>
</template>
